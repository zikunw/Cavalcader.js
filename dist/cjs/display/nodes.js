...
const CircleNode = (props) => {
    ...
    const nodeElement = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("text", { x: offsetX + nodeWidth / 2, y: offsetY + nodeHeight / 2, textAnchor: "middle", dominantBaseline: "middle", fontSize: 20, fontFamily: "monospace" }, name)));
    return nodeElement;
};
